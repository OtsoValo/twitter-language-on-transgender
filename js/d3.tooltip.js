  ...
  return this.each(function(d, i) {
    ...
    el.on('mouseover', function() {
      ...
      if (options.type === 'popover') {
        ...
        inner.append('h4').text(options.title).attr('class', 'popover-title');
        //console.log(options.content)
        //console.log(options.content[0][0].outerHTML);
        inner.append('div').attr('class', 'popover-content').append('p').html(options.content[0].outerHTML);
      }
